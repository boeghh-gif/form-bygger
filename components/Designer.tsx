    ...
    onDragEnd: (event: DragEndEvent) => {
      ...
      if (droppingSidebarBtnOverDesignerElement) {
        ...
        if (overElementIndex === -1) {
          throw new Error("Element blev ikke fundet.");
        }
      ...
      >
        ...
        >
          {!droppable.isOver && elements.length === 0 && (
            <p className="text-3xl text-muted-foreground flex flex-grow items-center font-bold">Smid her</p>
          )}
      ...
      {mouseIsOver && (
        <>
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-pulse">
            <p className="text-muted-foreground text-sm">Klik for egenskaber, eller træk for at flytte</p>
          </div>
        </>
      )}
